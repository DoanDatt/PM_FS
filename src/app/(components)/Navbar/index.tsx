  ...
  return (
    <div className="flex items-center justify-between bg-white px-4 py-3 dark:bg-black">
      ...
      <div className="flex items-center gap-8">
        ...
        <div className="h-min-[200px] relative flex">
          <Search className="left-4-[px] absolute top-1/2 mr-2 h-5 w-5 -translate-y-1/2 transform cursor-pointer dark:text-white" />
          <input
